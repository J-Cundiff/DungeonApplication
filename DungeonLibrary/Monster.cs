...
namespace DungeonLibrary
{
    public class Monster : Character
    {
        ...
        public static Monster GetMonster()
        {
            ...
            Vampire vampire = new Vampire("Dracula", 30, 50, 8, 8, 1, "The father of all the undead");
            Vampire vampire2 = new Vampire("Ammar", 35, 40, 10, 10, 1, "One of the oldest vampires still unalived..");

            Turtle turtle = new Turtle("Mikey", 25, 50, 10, 4, 1, "He is no longer a teenager but he is still a mutant turtle", 3, 10);

            Dragon dragon = new Dragon("Smaug", 35, 35, 10, 10, 1, "The last great dragon", isScaly: true);
            Dragon galzra = new Dragon();

            Undead zombie = new Undead();
            Undead skeleton = new Undead("Skeleton", 30, 45, 9, 12, 1, "A Skeleton holding a sword and shield");

            Creature spider = new Creature("Giant Black Widow", 30, 40, 12, 10, 1, "A 10-foot tall spider that shots poisionious webs");
