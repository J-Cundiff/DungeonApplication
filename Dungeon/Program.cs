    ...
    internal class Program
    {
        ...
        private static string GetRoom()
        {
            ...
            string[] rooms =
            {
             ...
             "the door is made of slate, it has a wood bolt on the inside and a hole has been drilled through the door at waist height but has been plugged with mud and wood. This room has an irregular flagstone tile floor. The floor of this room has several gentle waves worn into the stone, as if millions of feet wore some sort of haphazard paths into the stone. The ceiling is a coffered (flat ceiling with sunken rectangular recessed panels) and is covered with spikes. Many are rusted, stained, bent or even broken. They are spaced regularly every foot or so and protrude down about a foot.\n\n" +
